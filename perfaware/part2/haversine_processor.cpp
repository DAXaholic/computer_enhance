...
{
    // const char *num1 = "+123456789.123456789";
    // const char *num2 = "123456789.123456789";
    // const char *num3 = "-123456789.123456789";
    // f64 number;
    // u64 charsRead;
    // charsRead = ReadNumber(num1, strlen(num1), &number);
    // printf(" + sign: %.16f (%d characters read)\n", number, charsRead);
    // charsRead = ReadNumber(num2, strlen(num2), &number);
    // printf("No sign: %.16f (%d characters read)\n", number, charsRead);
    // charsRead = ReadNumber(num3, strlen(num3), &number);
    // printf(" - sign: %.16f (%d characters read)\n", number, charsRead);
    // return 0;
    if (argc < 2 || argc > 3) {
    ...
    // while (ReadNextJsonToken(curData, remainingBytes, &bytesRead, &token) && !failedProcessing && remainingBytes > 0)
    // {
    //     curData += bytesRead;
